...
<section>
  <div class="container inner_wrapper lender_profile">
    <div class="row">
      <div class="col-md-3 col-sm-12">
        ...
        <div class="cta_single">
            <?php if( get_field('button_link') ): ?><a href="<?php echo $redirect_url; ?>" target="_blank" class="blue_big_btn" rel="nofollow noindex noreferrer noopener">Apply Now</a><?php endif; ?>
    ...
    <div class="lender_offered">
        ...
        <div class="accordion_lender">
			...
			?>   
        	<button class="accordion active"><?php the_sub_field('item_title'); ?> <?php if (get_field('button_link')){ ?><a href="<?php echo $redirect_url; ?>" target="_blank" rel="nofollow noindex noreferrer noopener">Apply Now</a><?php } ?></button>
 ...
 <?php 
 					...
 					//$display_name = get_display_name(22);
					//echo $display_name;
    ...
    'cache_results'          => false
                    ...
                    $args = array( 'post_type' => 'post', 'posts_per_page' => 3, 'order' =>'DESC','meta_query' => array(
                        array(
                            'key'       => 'lenders_item',
                            'value'     => $lenderID,
                            'compare'   => '=',
                    ...
                    $argsCompanyReview = array( 'post_type' => 'company_review', 'posts_per_page' => 3, 'order' =>'DESC','meta_query' => array(
                        array(
                            'key'       => 'lenders_item',
                            'value'     => $lenderID,
                            'compare'   => '=',
                    ...
                    $page_query = get_posts( array_merge( $defaults, $argsCompanyReview ) );

                    $post_ids = array_merge ($post_query, $page_query);
                   if ( $post_ids ) {
                        $final_args = [
                            'post_type' => ['post', 'company_review'],
                            'post__in'  => $post_ids,
                            'posts_per_page' => 3,
                            'order'     => 'DESC' // If you need to keep the order from $post_ids
                        ];
                        $loopfinaldata = new WP_Query( $final_args );

                        // Run your loop as normal
                    //}
                    // echo '<pre>';
                    // print_r($loopfinaldata);
                    // die();
                    //$loop = new WP_Query( $args );
                    //$loopCompanyReview = new WP_Query( $argsCompanyReview );
                    if( $loopfinaldata->have_posts() ){
   ...
   <div class="articles_about_lender">
        ...
        <?php 
					...
					while ( $loopfinaldata->have_posts() ) : $loopfinaldata->the_post();						
				?>
