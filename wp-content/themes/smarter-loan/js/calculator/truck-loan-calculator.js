        ...
        e.default = {
            ...
            methods: {
                createChart: function() {
                    console.log(this.$refs.chart,6231);
    ...
    e.default = {
        ...
        data: function() {
            return {
                ...
                chartData: {
                    labels: ["Monthly Payment","Total Interest","Total Repayment"],
                    datasets: [{
                        data: ['3948','4762','50000'],
