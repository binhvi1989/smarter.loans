...
<div class="master-chart main_section">
    <div class="container">
        <center><h1 class="section-title">Personal Loan Calculator</h1></center>
    </div>
    <div class="container">
        <div class="row">
                        ...
                        <div class="loan_slider_main">
                            <div class="loan-pay-slider">
                                ...
                                <div class="slider_des_price">
                                    <span class="pull-left text_descrip chart_detailtxt">$0.5k</span><span class="text-center price slider_text_desc">$5,000</span><span class="pull-right text_info chart_detailtxt">$35K</span>
                                </div>
                                <input type="range" min="500" max="35000" step="500" value="5000" data-orientation="vertical" class="slider" id="price-range"/>
                            ...
                            <div class="loan-pay-slider">
                                ...
                                <div class="slider_des_price">
                                    <span class="pull-left text_descrip">1%</span><span class="text-center interest-rate slider_text_desc">15%</span><span class="pull-right text_descrip">59%</span>
                                </div>
                                <input type="range" min="1" max="59" value="15" step="0.1" data-orientation="vertical" class="slider" id="interest-range"/>
                            </div>
                            <div class="loan-pay-slider">
