...
<div class="master-chart main_section">
    <div class="container">
        <center><h1 class="section-title">Auto Loan Calculator</h1></center>
    </div>
    <div class="container">
        <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        <div class="loan_slider_main">
                            <div class="loan-pay-slider">
                                <label class="text-center slider_des">What is the vehicle price?</label>
                                <div class="slider_des_price">
                                    <span class="pull-left text_descrip chart_detailtxt">$2k</span><span class="text-center price slider_text_desc">$20,000</span><span class="pull-right text_info chart_detailtxt">$100K</span>
                                </div>
                                <input type="range" min="2000" max="100000" step="500" value="20000" data-orientation="vertical" class="slider" id="price-range"/>

                            </div>
                            <div class="loan-pay-slider">
                                <label class="text-center slider_des">Your downpayment</label>
                                <div class="slider_des_price">
                                    <span class="pull-left text_descrip">$0k</span><span class="text-center downpayment slider_text_desc">$1,000</span><span class="pull-right text_descrip">$100K</span>
                                </div>
                                <input type="range" min="0" max="100000" step="500" value="1000" data-orientation="vertical" class="slider" id="downpayment-range"/>
                            </div>
                            <div class="loan-pay-slider">
                                <label class="text-center slider_des">What is your estimated interest rate?</label>
                                <div class="slider_des_price">
                                    <span class="pull-left text_descrip">1%</span><span class="text-center interest-rate slider_text_desc">15%</span><span class="pull-right text_descrip">40%</span>
                                </div>
                                <input type="range" min="1" max="40" value="15" step="0.1" data-orientation="vertical" class="slider" id="interest-range"/>
                            </div>
                            <div class="loan-pay-slider">
