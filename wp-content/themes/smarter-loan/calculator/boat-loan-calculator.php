...
<div class="master-chart main_section">
     <div class="container">
         <center><h1 class="section-title">Boat Loan Calculator</h1></center>
     </div>
    <div class="container">
        <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        <div class="loan_slider_main">
                            <div class="loan-pay-slider">
                                <label class="text-center slider_des">What is the total price of the boat or yacht?</label>
                            ...
                            <div class="loan-pay-slider">
                                ...
                                <div class="slider_des_price">
                                    <span class="pull-left text_descrip">$0k</span><span class="text-center downpayment slider_text_desc">$5,000</span><span class="pull-right text_descrip">$100K</span>
                                </div>
                                <input type="range" min="0" max="100000" step="500" value="5000" data-orientation="vertical" class="slider" id="downpayment-range"/>
                            </div>
                            <div class="loan-pay-slider">
