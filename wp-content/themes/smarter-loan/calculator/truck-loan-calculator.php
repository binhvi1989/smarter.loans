...
.slider::-webkit-slider-thumb {
  ...
  background: #E93E51;*/
  cursor: pointer;
  /*box-shadow: 0 0 0 7px rgba(233, 62, 81, 0.3);*/
...
<div class="master-chart main_section">
  <div class="container">
  <center><h1 class="section-title">Truck Loan Calcualtor</h1></center>
</div>
    <div class="container">
        <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        <div class="loan_slider_main">
                            <div class="loan-pay-slider">
                                <label class="text-center slider_des">What is the total price of the truck(s) and trailer(s)?</label>
