...
<div class="master-chart main_section">
  <div class="container">
    <center><h1 class="section-title">Total price of the bus or buses 
</h1></center>
    </div>
  <div class="container">
      <div class="row">
                  ...
                  <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                      <div class="loan_slider_main">
                          <div class="loan-pay-slider">
                              <label class="text-center slider_des">Total price of the bus or buses</label>
                              <div class="slider_des_price">
                                  <span class="pull-left text_descrip chart_detailtxt">$5k</span><span class="text-center price slider_text_desc">$100,000</span><span class="pull-right text_info chart_detailtxt">$1000K</span>
                              </div>
                              <input type="range" min="5000" max="1000000" step="500" value="100000" data-orientation="vertical" class="slider" id="price-range"/>

                          </div>
                          <div class="loan-pay-slider">
                              <label class="text-center slider_des">Your downpayment</label>
                              <div class="slider_des_price">
                                  <span class="pull-left text_descrip">$0k</span><span class="text-center downpayment slider_text_desc">$10,000</span><span class="pull-right text_descrip">$500K</span>
                              </div>
                              <input type="range" min="0" max="500000" step="500" value="10000" data-orientation="vertical" class="slider" id="downpayment-range"/>
                          </div>
                          <div class="loan-pay-slider">
                              <label class="text-center slider_des">Approximate interest rate</label>
                              <div class="slider_des_price">
                                  <span class="pull-left text_descrip">1%</span><span class="text-center interest-rate slider_text_desc">5%</span><span class="pull-right text_descrip">30%</span>
                              </div>
                              <input type="range" min="1" max="30" value="5" step="0.1" data-orientation="vertical" class="slider" id="interest-range"/>
                          </div>
                          <div class="loan-pay-slider">
                              <label class="text-center slider_des">Term length</label>
                              <div class="slider_des_price">
