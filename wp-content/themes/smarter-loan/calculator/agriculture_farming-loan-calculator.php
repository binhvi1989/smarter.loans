...
<div class="master-chart main_section">
    <div class="container">
        <center><h1 class="section-title">Agriculture and Farming Equipment Calculator</h1></center>
    </div>
    <div class="container">
        <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        <div class="loan_slider_main">
                            <div class="loan-pay-slider">
                                <label class="text-center slider_des">What is the total price of the agriculture/farming equipment?</label>
                                <div class="slider_des_price">
                                    <span class="pull-left text_descrip chart_detailtxt">$5k</span><span class="text-center price slider_text_desc">$50,000</span><span class="pull-right text_info chart_detailtxt">$500K</span>
                                </div>
                                <input type="range" min="5000" max="500000" step="500" value="50000" data-orientation="vertical" class="slider" id="price-range"/>
                            ...
                            <div class="loan-pay-slider">
                                ...
                                <input type="range" min="0" max="250000" step="500" value="5000" data-orientation="vertical" class="slider" id="downpayment-range"/>
                            </div>
                            <div class="loan-pay-slider">
