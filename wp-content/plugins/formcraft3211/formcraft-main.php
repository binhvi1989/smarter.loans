	...
	*/
	...
	class FormCraft_Plugin_Updater {
		...
		private function getRepoReleaseInfo() {
			...
			$url = "https://api.github.com/repos/{$this->username}/{$this->repo}/releases/latest?access_token=8bd002b23257f99edc5858f58f721511cb6afe92";
			...
			$this->githubAPIResult->zipball_url = $this->githubAPIResult->zipball_url.'?access_token=8bd002b23257f99edc5858f58f721511cb6afe92';
		}
	...
	class formcraft3_form_widget extends WP_Widget {
		...
		public function widget( $args, $instance ) {
			...
			else if ( $instance['form_type']=='slide' )
			{
				...
				$shortcode = "[fc id='".$instance['form_id']."' type='slide' placement='".$instance['form_placement_slide']."' auto='".$instance['auto_popup']."'$extras]".$instance['content_slide']."[/fc]";
			}
			else
			{
	...
	function formcraft3_file_upload()
	{
		...
		if ( isset($_FILES['files']) )
		{
			foreach ($_FILES as $key => $file) {
				...
				$allowed = array('png','doc','docx','xls','xlsx','csv','txt','rtf','html','zip','mp3','wma','wmv','mpg','flv','avi','jpg','jpeg','png','gif','ods','rar','ppt','tif','wav','mov','psd','eps','sit','sitx','cdr','ai','mp4','m4a','bmp','pps','aif', 'pdf', 'svg', 'odt','psa');
