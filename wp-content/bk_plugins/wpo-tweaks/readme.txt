...
== Plugin Requirements ==
* This plugin requires WordPress 4.7 or greater
...
* Go to [Google PageSpeed](https://https://developers.google.com/speed/pagespeed/insights/) and test your site.
* Go to the [Pingdom Tools](https://https://tools.pingdom.com/) and test your site.
